...
<div class="contacts" id="contacts">
    <h1 class="title"><?php the_field('contacts_subtitle'); ?></h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined"><?php the_field('contacts_descr'); ?></div>
            </div>
            <div class="col-lg-6">
                <div id="map" class="contacts__map">
                <!-- <div class="contacts__map acf-map"> -->
                <!-- <?php echo do_shortcode( '[yamap center="55.7382,37.5072" height="100%" controls="55.738164984877976,37.50722765922547" zoom="16" type="" mobiledrag="0"][/yamap]' ) ?> -->
                <!-- <?php echo do_shortcode( '[yamap center="55.7382,37.5072" height="100%" controls="" zoom="16" type="" mobiledrag="0"][/yamap]' ) ?> -->
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div action="#" class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="9788965" title="Форма отзывов"]') ?>
                </div>
            </div>
        </div>
        <div class="row mt70">
                            ...
                            foreach( $comments_posts as $post ){
                                ...
                                ?>
                                    <li class="glide__slide">
                                        <div class="feedslider__title"><?php the_field('comments_name'); ?></div>
                                        <div class="feedslider__text"><?php the_field('comments_descr'); ?></div>
                                    </li>
                                <?php
                                }
                                wp_reset_postdata();
