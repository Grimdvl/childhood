<div class="question">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('instagram', 2) ?>" class="footer__social-item"><img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/instagram.svg" alt="инстаграм"></img></a>
                            <a href="<?php the_field('facebook', 2) ?>" class="footer__social-item"><img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/facebook.svg" alt="фэйсбук"></img></a>
                            <a href="<?php the_field('youtube', 2) ?>" class="footer__social-item"><img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/youtube.svg" alt="ютуб"></img></a>
        ...
        <?php
            wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAWMz5XYlWGFag0DzRzX81gVdAkzpWu9kY"></script>
