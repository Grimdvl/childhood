...
?>
        ...
        <div class="toys" id="toys">
            <div class="container">
                ...
                <h2 class="subtitle"><?php the_field('title_toys_1'); ?></h2>
                ...
                <h2 class="subtitle"><?php the_field('title_toys_2'); ?></h2>
                <div class="toys__wrapper">
                <?php
                    $posts = get_posts( array(
                        'numberposts' => -1,
