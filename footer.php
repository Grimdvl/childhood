        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="9125704" title="Форма вопросов"]'); ?>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('social_media_1', 2); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('social_media_2', 2); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('social_media_3', 2); ?>" class="footer__social-item">
    ...
    <?php wp_footer(); ?>
    <!-- <script src="https://maps.googleapis.com/maps/api/js?key=xxx&callback=Function.prototype"></script> -->
    </body>
</html>